...
pub fn encode_state_as_update_v2(doc: &mut YDoc, vector: Option<Uint8Array>) -> Uint8Array {
...
pub fn apply_update_v2(doc: &mut YDoc, diff: Uint8Array) {
...
impl YTransaction {
    ...
    pub fn diff_v2(&self, vector: Option<Uint8Array>) -> Uint8Array {
    ...
    pub fn apply_v2(&mut self, diff: Uint8Array) {
        let diff: Vec<u8> = diff.to_vec();
