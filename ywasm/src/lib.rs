...
///
/// Change detection is performed in the same Yrs transaction and includes delete-only changes,
/// which cannot be detected by comparing state vectors alone.
