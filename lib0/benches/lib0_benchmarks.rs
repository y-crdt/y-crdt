...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    group.bench_function("var_int (64 bit)", |b| b.iter(|| {
    ...
    group.bench_function("var_uint (32 bit)", |b| b.iter(|| {
        let mut encoder = Encoder::new();
    ...
    group.bench_function("uint32", |b| b.iter(|| {
        let mut encoder = Encoder::new();
        for i in 0..BENCHMARK_SIZE {
    ...
    group.bench_function("var_uint (64 bit)", |b| b.iter(|| {
        let mut encoder = Encoder::new();
    ...
    group.bench_function("uint64", |b| b.iter(|| {
        let mut encoder = Encoder::new();
        for i in 0..(BENCHMARK_SIZE as u64) {
