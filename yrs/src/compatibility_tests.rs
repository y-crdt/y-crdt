...
#[test]
fn negative_zero_decoding() {
    let data = &[
        0, 0, 6, 218, 250, 226, 225, 14, 2, 2, 1, 1, 0, 9, 39, 0, 40, 0, 39, 0, 40, 1, 39, 82, 71,
        114, 111, 111, 116, 115, 101, 113, 117, 101, 110, 99, 101, 105, 100, 99, 117, 116, 115,
        110, 97, 109, 101, 114, 111, 111, 116, 95, 95, 118, 101, 114, 115, 105, 111, 110, 95, 95,
        114, 111, 111, 116, 102, 97, 99, 101, 95, 101, 120, 112, 114, 101, 115, 115, 105, 111, 110,
        115, 114, 111, 111, 116, 99, 104, 97, 114, 97, 99, 116, 101, 114, 115, 4, 8, 2, 68, 1, 11,
        4, 16, 4, 10, 5, 1, 0, 0, 2, 1, 3, 1, 64, 1, 2, 65, 1, 1, 7, 0, 119, 21, 86, 57, 85, 107,
        57, 112, 120, 85, 75, 90, 73, 114, 87, 54, 99, 79, 107, 67, 48, 82, 103, 119, 12, 110, 101,
        119, 32, 115, 101, 113, 117, 101, 110, 99, 101, 125, 1, 0,
    ];
    Update::decode_v2(data).unwrap();
}
